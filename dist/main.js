...
.slider.round:before {
  border-radius: 50%;
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,kCAAkC;EAClC,aAAa;EACb,yBAAyB;EACzB,yCAAyC;AAC3C;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,iBAAiB;EACjB,YAAY;EACZ,iBAAiB;AACnB;;AAEA;EACE,YAAY;EACZ,gBAAgB;EAChB,kBAAkB;EAClB,gBAAgB;EAChB,+BAA+B;EAC/B,YAAY;EACZ,SAAS;EACT,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,mBAAmB;EACnB,8BAA8B;EAC9B,gBAAgB;EAChB,yBAAyB;EACzB,YAAY;EACZ,YAAY;EACZ,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE;IACE,YAAY;EACd;AACF;;AAEA;EACE,gBAAgB;EAChB,iBAAiB;EACjB,kBAAkB;EAClB,iBAAiB;AACnB;;AAEA;EACE,gBAAgB;EAChB,mBAAmB;AACrB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,eAAe;EACf,mBAAmB;AACrB;;AAEA;EACE,kBAAkB;EAClB,SAAS;EACT,WAAW;AACb;;AAEA;EACE,qBAAqB;EACrB,kBAAkB;EAClB,iBAAiB;AACnB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,UAAU;EACV,2BAA2B;AAC7B;;AAEA;EACE,kBAAkB;EAClB,qBAAqB;EACrB,WAAW;EACX,YAAY;EACZ,YAAY;AACd;;AAEA;EACE,UAAU;EACV,QAAQ;EACR,SAAS;AACX;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,MAAM;EACN,OAAO;EACP,QAAQ;EACR,SAAS;EACT,sBAAsB;AACxB;oBACoB;AACpB;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,WAAW;EACX,SAAS;EACT,WAAW;EACX,uBAAuB;EACvB,uBAAuB;EACvB,eAAe;AACjB;;AAEA;;;;;;GAMG;;AAEH;EACE,mCAAmC;EACnC,+BAA+B;EAC/B,2BAA2B;AAC7B;;AAEA,oBAAoB;AACpB;EACE,mBAAmB;AACrB;;AAEA;EACE,kBAAkB;AACpB","sourcesContent":["body {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  /* background-repeat: no-repeat; */\n  height: 100vh;\n  background-color: #e7f1fa;\n  font-family: Arial, Helvetica, sans-serif;\n}\n\n#search-section {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n#search {\n  padding: 10px 5px;\n  width: 500px;\n  font-size: 1.2rem;\n}\n\n#search-weather {\n  width: 200px;\n  margin-top: 10px;\n  padding: 15px 20px;\n  font-size: 1.3em;\n  background-color: darkslategrey;\n  color: white;\n  border: 0;\n  border-radius: 6px;\n  cursor: pointer;\n}\n\n#loader {\n  margin-top: 20px;\n}\n\n#weather-section {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: space-between;\n  margin-top: 30px;\n  background-color: #95c4e6;\n  color: white;\n  width: 500px;\n  border-radius: 6px;\n  padding: 0 20px;\n}\n\n@media only screen and (max-width: 1000px) {\n  #weather-section {\n    width: 350px;\n  }\n}\n\n#toggle-section {\n  margin-top: 20px;\n  text-wrap: nowrap;\n  align-self: center;\n  font-weight: bold;\n}\n\n#content {\n  margin-top: 10px;\n  margin-bottom: 20px;\n}\n\n#location {\n  font-size: 1.5rem;\n}\n\n#local-time {\n  margin-top: 5px;\n  margin-bottom: 10px;\n}\n\n#weather-icon {\n  position: relative;\n  top: 10px;\n  right: 10px;\n}\n\n#temperature {\n  display: inline-block;\n  font-size: 3.75rem;\n  font-weight: bold;\n}\n\n#description {\n  font-size: 1.2rem;\n}\n\n.error-msg {\n  color: red;\n  background-color: lightpink;\n}\n\n.switch {\n  position: relative;\n  display: inline-block;\n  width: 60px;\n  height: 34px;\n  bottom: 10px;\n}\n\n.switch input {\n  opacity: 0;\n  width: 0;\n  height: 0;\n}\n\n.slider {\n  position: absolute;\n  cursor: pointer;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: #ccc;\n/*   -webkit-transition: .4s;\n  transition: .4s; */\n}\n\n.slider:before {\n  position: absolute;\n  content: \"\";\n  height: 26px;\n  width: 26px;\n  left: 4px;\n  bottom: 4px;\n  background-color: white;\n  -webkit-transition: .4s;\n  transition: .4s;\n}\n\n/* input:checked+.slider {\n  background-color: #2196F3;\n}\n\ninput:focus+.slider {\n  box-shadow: 0 0 1px #2196F3;\n} */\n\ninput:checked+.slider:before {\n  -webkit-transform: translateX(26px);\n  -ms-transform: translateX(26px);\n  transform: translateX(26px);\n}\n\n/* Rounded sliders */\n.slider.round {\n  border-radius: 34px;\n}\n\n.slider.round:before {\n  border-radius: 50%;\n}"],"sourceRoot":""}]);
// Exports
...
function processDate(data) {
  const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.parse)(data, "yyyy-MM-dd HH:mm", new Date());
  // console.log(date);
  // console.log(format(date, "EEEE, LLL d, HH:mm"));
  return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(date, "EEEE, LLL d, HH:mm");
}
